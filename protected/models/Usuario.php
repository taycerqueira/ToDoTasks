...
class Usuario extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'tags' => array(self::HAS_MANY, 'Tag', 'usuarioId'),
			'tarefas' => array(self::MANY_MANY, 'Tarefa', 'usuario_tarefa(usuarioId, tarefaId)'),
			'tipoTarefas' => array(self::HAS_MANY, 'TipoTarefa', 'criadorId'),
		);
	}
